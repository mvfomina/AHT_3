package com.amazon.testing.listeners;

import com.amazon.testing.pageobject.LogUtil;
...
public class TestResultsListener implements ITestListener {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        com.amazon.testing.listeners.ReportUtils.makeScreenshot("Failure screen", (WebDriver) result.getTestContext().getAttribute("WebDriver"));
    }
